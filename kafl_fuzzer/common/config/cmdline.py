...
def add_args_fuzzer(parser):
    ...
    parser.add_argument('--nautilus', dest='nautilus', action='store_true', help='enable Nautilus grammar-driven mutations', default=True)
    parser.add_argument('--no-nautilus', dest='nautilus', action='store_false', help='disable Nautilus grammar-driven mutations')
    parser.add_argument('--nautilus-grammar', metavar='<file>', required=False, help='path to Nautilus Python grammar script', default='nautilus/grammars/xlsx_sheet.py')
    parser.add_argument('--nautilus-iterations', metavar='<n>', type=int, required=False, help='max Nautilus mutations per stage', default=64)
    parser.add_argument('--nautilus-depth', metavar='<n>', type=int, required=False, help='max Nautilus grammar recursion depth', default=6)
